            ...
            fields: [
              {
                ...
                options: {
                  label:
                    "Requested Foundation (if different from stock foundations)",
                  required: false,
        ...
        [
          {
            ...
            fields: [
              ...
              },
              {
                ...
                disabled: false,
                configUrl:
                  "https://contact-form.etssoft.net/app/settings?tab-active=reCaptcha",
                group: "",
                options: {
                  label: "",
                  name: "reCaptcha-4",
  ...
  },
  {
    ...
    form_content: {
      ...
      info: {
        ...
        bold_title: true,
        description:
          "Questions on a plan? We're here to help. Fill out the form below and we'll get you answers.",
...
const ETS_CF_CONFIG = {
  ...
  translations: {
    ...
    translation_field_12:
      "Max file size: 10 Mb. Accepted formats: {acceptable_file _types}",
  },
};
